...
import LanguageSwitcher from '../ui/LanguageSwitcher'; // Import
            ...
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-mono tracking-widest uppercase hidden sm:block">Administration</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                    <div className="text-right hidden sm:block">
                        ...
                        <p className="text-xs text-blue-600 font-medium">{t('admin.super_admin')}</p>
                    </div>
