...
export interface Room {
    ...
    mediaStates?: Record<string, MediaState>; // <-- NEW: Store media state
    ...
    chatBannedIds?: string[]; // IDs of users banned from chatting
...
export interface ServerToClientEvents {
    ...
    "host-status-result": (hasHost: boolean) => void;
    ...
    "timer-update": (timer: MeetingTimer | null) => void;
...
export interface ClientToServerEvents {
    "join-room": (
        ...
        name: string,
        forceJoin?: boolean,
        initialState?: MediaState, // <-- UPDATED: Add initial state
    ) => void;
    "create-room": (
        name: string,
        userId: string,
    ...
    "check-host-status": (roomId: string) => void; // <-- UPDATED SIGNATURE
